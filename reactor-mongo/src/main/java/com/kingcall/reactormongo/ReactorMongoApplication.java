package com.kingcall.reactormongo;

import com.kingcall.reactormongo.converter.MoneyReadConverter;
import com.kingcall.reactormongo.converter.MoneyWriteConverter;

import com.kingcall.reactormongo.model.Coffee;
...
@Slf4j
public class ReactorMongoApplication implements ApplicationRunner {
	@Autowired
	private ReactiveMongoTemplate mongoTemplate;
	private CountDownLatch cdl = new CountDownLatch(2);

	public static void main(String[] args) {
		SpringApplication.run(ReactorMongoApplication.class, args);
	}

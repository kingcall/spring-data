package com.kingcall.service;

import com.fasterxml.jackson.databind.ObjectMapper;

import com.kingcall.document.ProfileDocument;
...
import static com.kingcall.util.Constant.INDEX;
import static com.kingcall.util.Constant.TYPE;
...
public class ProfileService {
    ...
    @Autowired
    public ProfileService(@Qualifier("restHighLevelClient2") RestHighLevelClient client, ObjectMapper objectMapper) {
        this.client = client;
